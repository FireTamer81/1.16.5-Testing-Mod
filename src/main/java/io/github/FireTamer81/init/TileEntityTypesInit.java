...
public class TileEntityTypesInit
{
    ...
    public static final RegistryObject<TileEntityType<StrongBlockTileEntity>> WARENAI_BLOCK_BLACK_STRONGBLOCK_TILE = register(
            "strong_block_tile", StrongBlockTileEntity::new, WarenaiBlocksInit.WARENAI_BLOCK_BLACK);
