...
import io.github.FireTamer81.GeoPlayerModelTest._library.server.event.AnimationEvent;
...
public enum AnimationHandler {
    ...
    public <T extends Entity & IAnimatedEntity> void sendAnimationMessage(T entity, Animation animation) {
        ...
        TestModMain.NETWORK.send(PacketDistributor.TRACKING_ENTITY_AND_SELF.with(() -> entity), new AnimationMessage(entity.getEntityId(), ArrayUtils.indexOf(entity.getAnimations(), animation)));
    }
