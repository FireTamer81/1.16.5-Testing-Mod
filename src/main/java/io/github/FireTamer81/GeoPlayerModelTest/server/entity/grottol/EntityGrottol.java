...
import io.github.FireTamer81.GeoPlayerModelTest.server.ai.EntityAIGrottolFindMinecart;
import io.github.FireTamer81.GeoPlayerModelTest.server.ai.MMAIAvoidEntity;
...
import io.github.FireTamer81.GeoPlayerModelTest.server.entity.grottol.ai.EntityAIGrottolIdle;
...
import io.github.FireTamer81.GeoPlayerModelTest.server.tag.TagHandler;
...
public class EntityGrottol extends MowzieEntity {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (entity instanceof PlayerEntity) {
            PlayerEntity player = (PlayerEntity) entity;
            if (player.getHeldItemMainhand().canHarvestBlock(Blocks.DIAMOND_ORE.getDefaultState()) || player.getHeldItemMainhand().getItem().isIn(TagHandler.Items.CAN_HIT_GROTTOL)) {
