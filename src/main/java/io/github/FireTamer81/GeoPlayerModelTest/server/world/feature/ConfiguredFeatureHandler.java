...
public class ConfiguredFeatureHandler {
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(TestModMain.MODID, "configured_wrought_chamber"), CONFIGURED_WROUGHT_CHAMBER);
        Registry.register(registry, new ResourceLocation(TestModMain.MODID, "configured_barakoa_village"), CONFIGURED_BARAKOA_VILLAGE);
        Registry.register(registry, new ResourceLocation(TestModMain.MODID, "configured_frostmaw_spawn"), CONFIGURED_FROSTMAW);
