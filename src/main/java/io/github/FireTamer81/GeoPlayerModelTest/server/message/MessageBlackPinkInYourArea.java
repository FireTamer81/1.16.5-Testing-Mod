...
import io.github.FireTamer81.GeoPlayerModelTest.server.block.BlockGrottol;
...
public class MessageBlackPinkInYourArea {
        ...
        public void accept(final MessageBlackPinkInYourArea message, final Supplier<NetworkEvent.Context> contextSupplier) {
            ...
            context.enqueueWork(() -> {
                ...
                if (entity instanceof AbstractMinecartEntity) {
                    ...
                    TestModMain.PROXY.playBlackPinkSound(minecart);
                    ...
                    TestModMain.PROXY.minecartParticles(world, minecart, scale, x, y, z, state, pos);
                }
            });
