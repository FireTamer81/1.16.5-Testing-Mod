package io.github.FireTamer81.GeoPlayerModelTest.server.tag;
...
public class TagHandler {
    public static class Blocks {
        ...
        private static Tags.IOptionalNamedTag<Block> createTag(String name) {
            return BlockTags.createOptional(new ResourceLocation(TestModMain.MODID, name));
        }
    ...
    public static class Items {
        ...
        private static Tags.IOptionalNamedTag<Item> createTag(String name) {
            return ItemTags.createOptional(new ResourceLocation(TestModMain.MODID, name));
        }
    ...
    public static class EntityTypes {
        ...
        private static ITag.INamedTag<EntityType<?>> createTag(String name) {
            return EntityTypeTags.createOptional(new ResourceLocation(TestModMain.MODID, name));
        }
