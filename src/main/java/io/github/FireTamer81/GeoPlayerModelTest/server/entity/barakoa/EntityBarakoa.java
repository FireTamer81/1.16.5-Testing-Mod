...
import io.github.FireTamer81.GeoPlayerModelTest.client.particle.ParticleRibbon;
...
import io.github.FireTamer81.GeoPlayerModelTest.client.particle.util.RibbonComponent;
import io.github.FireTamer81.GeoPlayerModelTest.server.ai.EntityAIAvoidEntity;
import io.github.FireTamer81.GeoPlayerModelTest.server.ai.animation.*;
        ...
        goalSelector.addGoal(2, new SimpleAnimationAI<EntityBarakoa>(this, HEAL_START_ANIMATION, true, false) {
            ...
            public void tick() {
                ...
                if (sunblocker.getAnimationTick() == 19) {
                    ...
                    TestModMain.PROXY.playSunblockSound(sunblocker);
                }
                if (sunblocker.getAnimationTick() >= 19) {
