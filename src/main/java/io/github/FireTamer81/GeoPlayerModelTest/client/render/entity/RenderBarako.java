...
import io.github.FireTamer81.GeoPlayerModelTest.client.model.entity.ModelBarako;
...
public class RenderBarako extends MobRenderer<EntityBarako, ModelBarako<EntityBarako>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(TestModMain.MODID, "textures/entity/barako.png");
    private static final ResourceLocation TEXTURE_OLD = new ResourceLocation(TestModMain.MODID, "textures/entity/barako_old.png");
