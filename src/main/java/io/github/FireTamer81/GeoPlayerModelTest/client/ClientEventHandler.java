...
import io.github.FireTamer81.GeoPlayerModelTest.server.item.*;
    ...
    public void onRenderOverlay(RenderGameOverlayEvent.Post e) {
        ...
        if (e.getType() == ElementType.POTION_ICONS) {
            ...
            if (Minecraft.getInstance().player != null) {
                ...
                if (frozenCapability != null && frozenCapability.getFrozen() && Minecraft.getInstance().gameSettings.getPointOfView() == PointOfView.FIRST_PERSON) {
