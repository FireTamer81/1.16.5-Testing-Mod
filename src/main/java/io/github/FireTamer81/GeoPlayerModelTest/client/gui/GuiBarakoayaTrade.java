...
import io.github.FireTamer81.GeoPlayerModelTest.server.inventory.InventoryBarakoaya;
...
public final class GuiBarakoayaTrade extends ContainerScreen<ContainerBarakoayaTrade> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(TestModMain.MODID, "textures/gui/container/barakoa.png");
