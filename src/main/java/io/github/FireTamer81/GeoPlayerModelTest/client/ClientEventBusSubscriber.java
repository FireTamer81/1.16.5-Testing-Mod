...
import io.github.FireTamer81.GeoPlayerModelTest.client.gui.GuiBarakoTrade;
import io.github.FireTamer81.GeoPlayerModelTest.client.gui.GuiBarakoayaTrade;
...
import io.github.FireTamer81.GeoPlayerModelTest.server.inventory.ContainerHandler;
import io.github.FireTamer81.GeoPlayerModelTest.server.item.ModSpawnEggItem;
...
//        RenderingRegistry.registerEntityRenderingHandler(EntityHandler.SCULPTOR.get(), RenderSculptor::new);
    ...
    public static void onRegisterModels(ModelRegistryEvent modelRegistryEvent) {
        ...
        for (MaskType type : MaskType.values()) {
            ModelLoader.addSpecialModel(new ModelResourceLocation(TestModMain.MODID + ":barakoa_mask_" + type.name + "_frame", "inventory"));
        }
    }
