package io.github.FireTamer81.GeoPlayerModelTest.client.gui;
...
import io.github.FireTamer81.GeoPlayerModelTest.server.inventory.InventoryBarako;
import io.github.FireTamer81.GeoPlayerModelTest.server.item.ItemHandler;
import io.github.FireTamer81.GeoPlayerModelTest.server.message.MessageBarakoTrade;
...
public final class GuiBarakoTrade extends ContainerScreen<ContainerBarakoTrade> implements InventoryBarako.ChangeListener {
    private static final ResourceLocation TEXTURE_TRADE = new ResourceLocation(TestModMain.MODID, "textures/gui/container/barako_trade.png");
    private static final ResourceLocation TEXTURE_REPLENISH = new ResourceLocation(TestModMain.MODID, "textures/gui/container/barako_replenish.png");
    ...
    protected void actionPerformed(Button button) {
        if (button == grantButton) {
            hasTraded = true;
            updateButton();
            TestModMain.NETWORK.sendToServer(new MessageBarakoTrade(barako));
