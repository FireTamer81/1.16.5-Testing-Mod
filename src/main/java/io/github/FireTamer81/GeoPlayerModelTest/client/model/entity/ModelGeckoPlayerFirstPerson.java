...
public class ModelGeckoPlayerFirstPerson extends MowzieAnimatedGeoModel<GeckoPlayer> {
    ...
    public boolean resourceForModelId(AbstractClientPlayerEntity player) {
        this.animationFileLocation = new ResourceLocation(TestModMain.MODID, "animations/animated_player_first_person.animation.json");
        this.modelLocation = new ResourceLocation(TestModMain.MODID, "geo/animated_player_first_person.geo.json");
