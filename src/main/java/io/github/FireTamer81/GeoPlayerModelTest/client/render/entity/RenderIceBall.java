...
import io.github.FireTamer81.GeoPlayerModelTest.client.model.entity.ModelIceBall;
...
public class RenderIceBall extends EntityRenderer<EntityIceBall> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(TestModMain.MODID, "textures/effects/ice_ball.png");
