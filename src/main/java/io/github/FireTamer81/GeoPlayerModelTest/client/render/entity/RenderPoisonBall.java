...
import io.github.FireTamer81.GeoPlayerModelTest.client.model.entity.ModelPoisonBall;
...
public class RenderPoisonBall extends EntityRenderer<EntityPoisonBall> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(TestModMain.MODID, "textures/effects/poison_ball.png");
