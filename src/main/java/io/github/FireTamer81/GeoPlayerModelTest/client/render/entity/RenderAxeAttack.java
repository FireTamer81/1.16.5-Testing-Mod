...
import io.github.FireTamer81.GeoPlayerModelTest.client.model.entity.ModelAxeAttack;
...
public class RenderAxeAttack extends EntityRenderer<EntityAxeAttack> {
    public static ResourceLocation TEXTURE = new ResourceLocation(TestModMain.MODID, "textures/entity/wroughtnaut.png");
